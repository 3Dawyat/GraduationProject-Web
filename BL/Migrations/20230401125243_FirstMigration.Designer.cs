...
namespace BL.Migrations
{
    ...
    [Migration("20230401125243_FirstMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pharmacy_DomainModels.Models.DB_Models.TbJobs", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
            ...
            modelBuilder.Entity("Pharmacy_DomainModels.Models.DB_Models.TbSalesInvoices", b =>
                {
                    ...
                    b.Property<string>("BodyTempreature")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Pharmacy_DomainModels.Models.DB_Models.TbUsers", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Pharmacy_DomainModels.Models.DB_Models.VwUserWithJob", b =>
                {
                    b.Property<bool?>("Active")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Pharmacy_DomainModels.Models.DB_Models.TbAuthorization", b =>
                {
                    ...
                    b.HasOne("Pharmacy_DomainModels.Models.DB_Models.TbJobs", "Jop")
                        .WithMany("TbAuthorization")
                        .HasForeignKey("JopId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_TbAuthorization_TbJobs1");
            ...
            modelBuilder.Entity("Pharmacy_DomainModels.Models.DB_Models.TbSalesInvoices", b =>
                {
                    b.HasOne("Pharmacy_DomainModels.Models.DB_Models.TbCustomers", "Customer")
                        .WithMany("TbSalesInvoices")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("FK_TbSalesInvoices_TbCustomers");

                    b.HasOne("Pharmacy_DomainModels.Models.DB_Models.TbDelivryMen", "DelivryMan")
                        .WithMany("TbSalesInvoices")
                        .HasForeignKey("DelivryManId")
                        .HasConstraintName("FK_TbSalesInvoices_TbDelivryMen");

                    b.HasOne("Pharmacy_DomainModels.Models.DB_Models.TbSafes", "Safe")
                        .WithMany("TbSalesInvoices")
                        .HasForeignKey("SafeId")
                        .HasConstraintName("FK_TbSalesInvoices_TbSafes");
