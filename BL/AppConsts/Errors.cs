namespace BL.AppConsts
{
    public static class Errors
    {
        ...
        public const string DuplicatedData = "User with the same data is already exists !";
        ...
        public const string InvalidPressure = "{0} should be like 120/80 ";
        ...
        public const string OnlyNumber = "Only Number are allowed.";
        public const string Age = "Make sure to type the correct age";
        public const string Gender = "Only Male or Female are allowed !";
        ...
        public const string SaveOperation = "An error occurred while completing the operation !";
    }
}
